...
{
	public class SlidingTabScrollView1 : HorizontalScrollView
	{
		...
		private static SlidingTabStrip1 mTabStrip;
		...
		public SlidingTabScrollView1(Context context) : this(context, null) { }

		public SlidingTabScrollView1(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public SlidingTabScrollView1(Context context, IAttributeSet attrs, int defaultStyle)
			: base(context, attrs, defaultStyle)
		{
			...
			mTabStrip = new SlidingTabStrip1(context);
		...
		private void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((SlidingTabsFragment1.SamplePagerAdapter1)adapter).GetHeaderTitle(i);
